...
# Output: Settings/FileSettings（包含 infra/模型/源列表等配置；并包含 chat 回退开关）
...
class Settings(BaseSettings):
    ...
    # Chat behavior: whether /chat may fall back to llm.deep (e.g. local vLLM) on network/auth/billing failures.
